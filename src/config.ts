...
export class JournalrConfig {
    ...
    public constructor({ attachmentFormat, contextMenuFormat, journalFormats }: { attachmentFormat: string, contextMenuFormat: string, journalFormats: string[] }) {
    ...
    public static fromConfig(): JournalrConfig {
        ...
        return new JournalrConfig({
            "attachmentFormat": journalr.get("attachmentFormat") ?? "_attachments/YYYYMMDDhhmmss",
